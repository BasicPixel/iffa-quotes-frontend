const About = () => {
  return (
    <div className="bg-slate-300 text-slate-800 rounded p-2">
      ...
      <p>
        مشروع "ولْيَسْتَعْفِف" يهدف إلى إعانة الشباب على العفة وعلى غض البصر، من
        خلال توفير ونشر ما يثبت المؤمن ويجدد استحضاره، من آيات وأحاديث ونقولات
        عن أئمة وعلماء السلف والخلف.
      </p>
      <p>
